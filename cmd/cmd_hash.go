...
func hSet(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func hSetNx(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func hGet(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func hGetAll(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func hMSet(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args)%2 != 1 {
...
func hMGet(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) <= 1 {
...
func hDel(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) <= 1 {
...
func hKeyExists(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func hExists(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func hLen(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func hKeys(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func hVals(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func hClear(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func hExpire(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func hTTL(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
