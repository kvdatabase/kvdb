...
func zAdd(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func zScore(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func zCard(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func zRank(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func zRevRank(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func zIncrBy(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func zRange(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
...
func zRevRange(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 && len(args) != 4 {
...
func zRawRange(db *kvdb.RoseDB, args []string, rev bool) (res interface{}, err error) {
	withScores := false
	if len(args) == 4 {
...
func zRem(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func zGetByRank(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func zRevGetByRank(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func zRawGetByRank(db *kvdb.RoseDB, args []string, rev bool) (res interface{}, err error) {
...
func zScoreRange(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func zSRevScoreRange(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func zRawScoreRange(db *kvdb.RoseDB, args []string, rev bool) (res interface{}, err error) {
...
func zKeyExists(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func zClear(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func zExpire(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func zTTL(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
