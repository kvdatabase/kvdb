...
import (
	...
	"github.com/kvdatabase/kvdb/ds/list"
	"github.com/tidwall/redcon"
	"strconv"
)

func lPush(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) < 2 {
...
func rPush(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) < 2 {
...
func lPop(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func rPop(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func lIndex(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 0 {
...
func lRem(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func lInsert(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 4 {
...
func lSet(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func lTrim(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func lRange(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func lLen(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func lKeyExists(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func lValExists(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func lClear(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func lExpire(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func lTTL(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
