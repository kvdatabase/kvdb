...
func set(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func get(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func setNx(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func setEx(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func getSet(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func mSet(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args)%2 != 0 {
...
func mGet(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) <= 0 {
...
func appendStr(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func strExists(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func remove(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func prefixScan(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func rangeScan(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func expire(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func persist(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func ttl(db *kvdb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
