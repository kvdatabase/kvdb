...
var host = flag.String("h", "127.0.0.1", "the kvdb server host, default 127.0.0.1")
var port = flag.Int("p", 5200, "the kvdb server port, default 5200")

const cmdHistoryPath = "/tmp/kvdb-cli"
